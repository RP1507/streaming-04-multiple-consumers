"""
    ...
    Modifying the emitter and listener to send messages from a .csv file rather than from the console.
...
def send_message(host: str, queue1: str, message: str):
    """
    ...
    try:
        ...
        ch.basic_publish(exchange="", routing_key=queue1, body=message)
